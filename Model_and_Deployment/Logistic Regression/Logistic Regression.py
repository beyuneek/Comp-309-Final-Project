# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 00:17:56 2023
...
"""
Handling Imbalance class and Data Splitting(train and test) 
"""
...
estimator = LogisticRegression(max_iter=30000)
...
joblib.dump(logreg_model, os.path.join(current_directory, 'model_lr.pkl'))
print("Model dumped!")
